  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (mode === 'signin') {
        ...
        setMessage('Password reset not yet implemented');
      }
    } catch (err) {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-gray-800 rounded-xl p-6 w-full max-w-md mx-4 relative">
        ...
        {mode !== 'forgot' && (
          <div className="space-y-3 mb-6">
            ...
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-gray-700 text-white rounded-lg font-medium hover:bg-gray-600 transition disabled:opacity-50"
            >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {message && (
            <div className="text-green-400 text-sm bg-green-900/30 p-3 rounded-lg">
              {message}
            </div>
          )}
